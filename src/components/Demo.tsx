      ...
      <div className="container mx-auto px-4">
          ...
          >
            <AnimatePresence mode="wait">
              {activeTab === 'orders' && (
                ...
                >
                  <div className="bg-white rounded-lg p-6 shadow-sm">
                    <h3 className="text-2xl font-semibold text-gray-900 mb-6">Live Order Dashboard</h3>
              ...
              {activeTab === 'analytics' && (
                ...
                >
                  <h3 className="text-2xl font-semibold text-gray-900 mb-6">Analytics Dashboard</h3>
                  ...
                  <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <div className="text-gray-600">Interactive Charts & Graphs</div>
                      <div className="text-sm text-gray-500 mt-1">Real-time data visualization</div>
                    </div>
                  </div>
                </motion.div>
              )}
              ...
              {activeTab === 'mobile' && (
                <motion.div
                  ...
                  className="bg-white rounded-lg p-6 shadow-sm"
                >
                  <h3 className="text-2xl font-semibold text-gray-900 mb-6">Mobile Experience</h3>
                  
                  <div className="flex flex-col lg:flex-row items-center justify-center space-y-8 lg:space-y-0 lg:space-x-12">
                    <div className="flex space-x-4">
                      <div className="w-64 h-96 bg-gradient-to-b from-gray-900 to-gray-800 rounded-3xl p-4 shadow-2xl">
                        <div className="bg-white rounded-2xl h-full p-4 flex flex-col">
                          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg p-3 mb-4">
                            <div className="text-white font-semibold text-center">ScalePOS</div>
                          </div>
                          ...
                          <div className="space-y-3 flex-1">
                            <div className="bg-gray-50 rounded-lg p-3">
                              ...
                              <div className="grid grid-cols-2 gap-2 mt-2">
                                <div className="bg-blue-100 rounded p-2 text-center text-xs">Orders</div>
                                <div className="bg-indigo-100 rounded p-2 text-center text-xs">Menu</div>
                                <div className="bg-cyan-100 rounded p-2 text-center text-xs">Reports</div>
                                <div className="bg-purple-100 rounded p-2 text-center text-xs">Settings</div>
                              </div>
                            </div>
                      ...
                      <div className="w-48 h-80 bg-gradient-to-b from-gray-900 to-gray-800 rounded-3xl p-3 shadow-2xl">
                        <div className="bg-white rounded-2xl h-full p-3 flex flex-col">
                          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg p-2 mb-3">
                            <div className="text-white font-semibold text-center text-sm">Kitchen Display</div>
                          </div>
        ...
        >
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-4 rounded-lg font-semibold text-lg shadow-lg hover:shadow-xl transition-shadow flex items-center space-x-2 mx-auto"
          >
